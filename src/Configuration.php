...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://demo.akeneo.com';
     ...
     * @var string
     */
    protected $userAgent = 'Efsa-AkeneoApi/{packageVersion}/{language}';
    ...
    {
        $report  = 'PHP SDK (Efsa\AkeneoApi) Debug Report:' . PHP_EOL;
