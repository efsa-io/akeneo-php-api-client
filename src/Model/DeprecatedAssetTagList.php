...
/**
 * DeprecatedAssetTagList Class Doc Comment
 *
 * @category Class
 * @package  Efsa\AkeneoApi
 * @author   OpenAPI Generator team
 ...
 */
class DeprecatedAssetTagList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeprecatedAssetTagList';
     ...
     * Sets code
     *
     * @param string $code PAM asset tag code
     *
     * @return self
     */
