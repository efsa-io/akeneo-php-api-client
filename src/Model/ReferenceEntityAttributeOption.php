...
/**
 * ReferenceEntityAttributeOption Class Doc Comment
 *
 * @category Class
 * @package  Efsa\AkeneoApi
 * @author   OpenAPI Generator team
 ...
 */
class ReferenceEntityAttributeOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReferenceEntityAttributeOption';
     ...
     * Sets code
     *
     * @param string $code Attribute's option code
     *
     * @return self
     */
